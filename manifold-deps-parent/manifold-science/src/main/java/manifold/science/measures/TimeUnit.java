...
public final class TimeUnit extends AbstractPrimaryUnit<Time, TimeUnit> implements TemporalUnit {
    ...
    // SI Units
    public static final TimeUnit Femto = get(1fe, Duration.ofNanos(0), true, false, "Femtosecond", "fs");
    public static final TimeUnit Pico = get(1p, Duration.ofNanos(0), true, false, "Picosecond", "ps");
    public static final TimeUnit Nano = get(1n, ChronoUnit.NANOS.getDuration(), false, false, "Nanosecond", "ns");
    public static final TimeUnit Micro = get(1u, ChronoUnit.MICROS.getDuration(), false, false, "Microsecond", "µs");
    public static final TimeUnit Milli = get(1m, ChronoUnit.MILLIS.getDuration(), false, false, "Millisecond", "ms");
    public static final TimeUnit Second = get(1r, ChronoUnit.SECONDS.getDuration(), false, false, "Second", "s");
    public static final TimeUnit Minute = get(60r, ChronoUnit.MINUTES.getDuration(), false, false, "Minute", "min");
    public static final TimeUnit Hour = get(60r * 60, ChronoUnit.HOURS.getDuration(), false, false, "Hour", "hr");
    public static final TimeUnit Day = get(24r * 60 * 60, ChronoUnit.DAYS.getDuration(), true, true, "Day", "day");
    public static final TimeUnit Week = get(7r * 24 * 60 * 60, ChronoUnit.WEEKS.getDuration(), true, true, "Week", "wk");

    // Mean Gregorian (ISO Calendar) units
    public static final TimeUnit Month = get(31556952r / 12, ChronoUnit.MONTHS.getDuration(), true, true, "Month", "mo");
    public static final TimeUnit Year = get(31556952r, ChronoUnit.YEARS.getDuration(), true, true, "Year", "yr");
    public static final TimeUnit Decade = get(31556952r * 10, ChronoUnit.DECADES.getDuration(), true, true, "Decade", "decade");
    public static final TimeUnit Century = get(31556952r * 100, ChronoUnit.CENTURIES.getDuration(), true, true, "Century", "century");
    public static final TimeUnit Millennium = get(31556952k, ChronoUnit.MILLENNIA.getDuration(), true, true, "Millennium", "millennium");
    public static final TimeUnit Era = get(31556952G, ChronoUnit.ERAS.getDuration(), true, true, "Era", "era");
