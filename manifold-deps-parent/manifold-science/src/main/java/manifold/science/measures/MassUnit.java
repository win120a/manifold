...
public final class MassUnit extends AbstractPrimaryUnit<Mass, MassUnit> {
    ...
    public static final MassUnit Nano = get(1p, "Nanogram", "µg");
    public static final MassUnit Micro = get(1n, "Microgram", "µg");
    public static final MassUnit Milli = get(1u, "Milligram", "mg");
    public static final MassUnit Gram = get(1m, "Gram", "g");
    public static final MassUnit Kilogram = get(1r, "Kilogram", "kg");
    public static final MassUnit Tonne = get(1k, "Metric Ton", "tonne");
