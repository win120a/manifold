...
public final class TemperatureUnit implements Unit<Temperature, TemperatureUnit> {
    ...
    public static final TemperatureUnit Fahrenheit = get(degF -> (degF + 459.67r) * "5/9"
    r,degK ->degK *"9/5"r -459.67r,"Fahrenheit","°F");

    public static final TemperatureUnit Rankine = get(degR -> degR * "5/9"r, degK -> degK * "9/5"r, "Rankine", "°R");

    public static final TemperatureUnit Delisle = get(De -> 373.15r - De * "2/3"r, degK -> (373.15r - degK) * "3/2"
    r,"Delisle","°De");

    public static final TemperatureUnit Newton = get(degN -> degN * "100/33"r + 273.15r, degK -> (degK - 273.15r) * "33/100"
    r,"Newton","°N");
