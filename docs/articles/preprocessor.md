...
Discover how to build multiple targets from a single Java codebase
using [the new preprocessor](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-preprocessor)
...
further ado I'll conclude with pointing out the decision to keep *The Macro* out of Java's screenplay proved salutary
and
productive. The End.
...
> method bodies, can only reference static final variables, and requires all code to compile regardless of the
> conditions,
...
Here the screencast demonstrates the preprocessor via IntelliJ IDEA using
...
more about this is
the [docs](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-preprocessor).
...
visualize exactly how your code reacts to the preprocessor directives and symbols you
use. [Check it out](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-preprocessor)
.
